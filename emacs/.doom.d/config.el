...
(setq doom-font (font-spec :family "Hack NF" :size 14 :weight 'semi-light))
;; |doom-variable-pitch-font (font-spec :family "Fira Code NF" :size 13))
;;
