...
vim.opt.inccommand =
"split"                                -- to split the buffer with the buffer showing the diff when doing a search replace or some other stuff
vim.opt.ignorecase = false             -- ignores letter cases
...
vim.opt.backspace =
"start,eol,indent"                     -- This option specifies which characters can be deleted with the Backspace key , inside the quotes are different types chatgipitty it
