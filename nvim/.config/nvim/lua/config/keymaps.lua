...
-- vim.api.nvim_set_keymap("n", ";f", ":Telescope file_browser path=%:p:h select_buffer=true<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", ";f", "<cmd>Oil<CR>", { noremap = true })
...
vim.keymap.set("n", "<leader>wfr", function()
